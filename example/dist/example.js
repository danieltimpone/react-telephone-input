...
var ReactTelephoneInput = React.createClass({
    ...
    formatNumber: function formatNumber(text, pattern) {
        ...
        console.log(this.state.selectedCountry.dialCode);
    ...
    _fillDialCode: function _fillDialCode() {
        ...
        // console.log(this.state.formattedNumber, this.state.formattedNumber.indexOf(this.state.selectedCountry.dialCode))
        // if (this.state.formattedNumber.indexOf(this.state.selectedCountry.dialCode) !== 1) {
        //     var newNumber = this.state.formattedNumber
        //                         .split('')
        //                         .splice(0,1)
        //     newNumber.unshift(this.state.selectedCountry.dialCode);
        //     console.log(newNumber)
        //     this.setState({
        //         formattedNumber: newNumber.join(''),
        //     });
        // }
    },
